...
describe('CreateConversationUseCase', () => {
  let conversationRepository: jest.Mocked<
    Pick<IConversationRepository, 'findByUserId' | 'save'>
  >;
  ...
  beforeEach(() => {
    relations = {
      [BOB]: FriendshipStatus.Accepted,
      [CAROL]: FriendshipStatus.Accepted,
    };
    ...
    friendshipRepository = {
      findBetween: jest
        .fn()
        .mockImplementation(async (_a: string, b: string) =>
