...
export class CreateMessageDto {
  ...
  @ApiPropertyOptional({
    example: 'Hello world!',
    description: 'Bắt buộc với type=text, optional với type=image',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: "Chỉ dùng khi type='image'",
  })
  ...
  @ApiPropertyOptional({
    ...
    description: "Chỉ dùng khi type='sticker'",
  })
